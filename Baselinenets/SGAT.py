...
class SGAT(nn.Module):
    def __init__(self,
        ...
        self.gat_layers.append(GraphAttention( g, in_dim, num_hidden, heads[0], feat_drop, attn_drop, alpha,bias_l0, False, l0=l0, min=0))
        # hidden layers
    ...
    def forward(self, inputs):
        ...
        h = inputs.x
        edges = "__ALL__"
        h, edges = self.gat_layers[0](h, edges, skip=0)
        ...
        # output projection
        logits,_ = self.gat_layers[-1](h, edges, skip=1)  #torch.Size([3327, 1, 6])
